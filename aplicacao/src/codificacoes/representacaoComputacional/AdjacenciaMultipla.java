 ...
 * @author BRUNO
 */
public class AdjacenciaMultipla {
    
    private int numeroVertices;
    private RepresentacaoComputacionalMultipla representacao;
    private boolean tipoGrafo;
    
    public AdjacenciaMultipla(int numeroVertices, RepresentacaoComputacionalMultipla representacao, boolean tipoGrafo){
    ...
    public RepresentacaoComputacionalMultipla getRepresentacao() {
